...
//         console.log(error)
//     })
var readFileAsync = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, fs_1.default.promises.readFile('./clase-6/text2.txt', 'utf-8')];
            case 1:
                data = _a.sent();
                console.log(data);
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
                console.log('Ese archivo no existe', error_1);
                return [3 /*break*/, 3];
